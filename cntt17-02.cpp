...
int main() {
    ...
    if (!htmlFile.is_open()) {
        cout << " Khong the tao tep index.html ! " << endl;
        return 1;
    }
    htmlFile << "<html>\n";
    htmlFile << "<head>\n";
	...
	htmlFile << "<small class=\"copyright\">Designed with <span class=\"sr-only\">love</span><i class=\"fas fa-heart\" style=\"color: #fb866a;\"></i> by <a class=\"app-link\" href=\"https://www.facebook.com/contact.dngocdong/\" target=\"_blank\">";
	htmlFile << "Trump Dev</a> for developers</small>";
    htmlFile << "</div>\n";
    htmlFile << "</body>\n";
    htmlFile << "</html>\n";
    ...
    cout << "Tep tin index.html da duoc tao thanh cong." << endl;
